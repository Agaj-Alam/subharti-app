      ...
      <View className="flex-1 bg-gray-100 p-4">
        ...
        <View className="bg-white rounded-2xl p-4 flex-row items-center mb-4 mx-2">
          ...
          <View className="flex-1">
            ...
            <Text className="text-lg text-gray-600 mb-1">{user.application_id}</Text>
          </View>
        </View>
        ...
        <View className="bg-white rounded-2xl p-4 mb-4">
          ...
          <View className="flex-row rounded-full overflow-hidden ">
            ...
            <View className="flex-1 bg-orange-600  border-l-2 border-white">
              <Text className="text-white text-center font-semibold">
                PENDING
              </Text>
            </View>
          ...
          <View className="flex-row justify-between mt-4">
            <View className="bg-indigo-100 rounded-2xl p-3 w-[41%] items-center justify-center">
              ...
              <Text className=" mt-1">10-Dec-26</Text>
            </View>
            <View className="bg-indigo-100 rounded-2xl p-3 w-[41%] items-center justify-center">
        ...
        <View className="bg-white rounded-2xl p-4 ">
          ...
          <Text className="mb-3 text-gray-600 text-lg">05-Dec-2026</Text>
          ...
          <Text className=" text-gray-600 text-lg">
            I have to go to visit hospital for medical checkup
          </Text>
        </View>
            ...
            <View style={{ minWidth: 535 }} >
              ...
              {/* Header  */}
               <View className="flex-row bg-indigo-800 text-lg p-4 border-b border-gray-600">
                ...
                <View className="flex-1">
                  <Text className="text-white text-center font-semibold">Remark Status</Text>
                </View>
              </View>
              {/* Row 1*/}
              <View className="flex-row  p-4 border-b border-gray-400 ">
                ...
                <View className="flex-1">
                  <Text className="text-black text-left text-lg">Dr.MANOJ KAPIL</Text>
                </View>

                <View className="flex-1">
                  <Text className="text-black text-right text-lg mr-3 ">Approved</Text>
                </View>
              </View>
              ...
              <View className="flex-row  p-4 border-b border-gray-400">
                ...
                <View className="flex-1">
                  <Text className="text-black text-left text-lg ml-16">Mr.Bipul Kumar Sing</Text>
                </View>

                <View className="flex-1">
                  <Text className="text-black text-right text-lg mr-3">Request</Text>
                </View>
              </View>
              ...
              <View className="flex-row  p-3 border-b border-gray-400">
                ...
                <View className="flex-1">
                  <Text className="text-black text-left text-lg ml-5">Mr.NARESH KUMAR</Text>
                </View>
